...
<div class="post">
	...
	<div class="post-article">
		<div class="post-info-i">
			...
			<small><i class="fa fa-calendar"></i><?php $this->date('Y年m月d日'); ?><?php if($this->user->hasLogin()): ?> <a href="<?php $this->options->adminUrl("write-page.php?cid=".$this->cid); ?>"><i class="fa fa-pencil-square-o"></i>编辑</a><?php endif; ?></small>
		</div>
