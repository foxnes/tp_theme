...
?>
<!DOCTYPE HTML>
<html style="background-image: url(<?php if ($this->options->bgimg): ?><?php $this->options->bgimg();else: ?>https://wx3.sinaimg.cn/large/005ShQFIly1fvbi55yk1nj30rs0rsaap.jpg<?php endif; ?>);">
<head>
